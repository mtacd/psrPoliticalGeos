...
def Model(PSR_assets = PSRs,
    ...
    arcpy.analysis.SpatialJoin(
        ...
        join_type = "KEEP_ALL",
        field_mapping = f"KEY_ASSET \"KEY_ASSET\" true true false 4 Long 0 0,First,#,{PSR_Assets_XY},KEY_ASSET,-1,-1; LONGITUDE \"LONGITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_XY},LONGITUDE,-1,-1; LATITUDE \"LATITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_XY},LATITUDE,-1,-1; DIST_CITY_COUNCIL \" DIST_CITY_COUNCIL \" true true false 50 Text 0 0,First,#,{PSR_Assets_XY}, DIST_CITY_COUNCIL,-1,-1; DIST_COMMUNITY \" DIST_COMMUNITY \" true true false 50 Text 0 0,First,#,{PSR_Assets_XY}, DIST_COMMUNITY,-1,-1; DIST_CONGRESSIONAL \" DIST_CONGRESSIONAL \" true true false 50 Text 0 0,First,#,{PSR_Assets_XY}, DIST_CONGRESSIONAL,-1,-1; DIST_STATE_ASSEMBLY \" DIST_STATE_ASSEMBLY \" true true false 50 Text 0 0,First,#,{PSR_Assets_XY}, DIST_STATE_ASSEMBLY,-1,-1; DIST_STATE_SENATE \" DIST_STATE_SENATE \" true true false 50 Text 0 0,First,#,{PSR_Assets_XY}, DIST_STATE_SENATE,-1,-1; City_Council_Parent_Dist_ID \"City_Council_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{cityCouncil}, CounDist,-1,-1",
        search_radius = "", 
        distance_field_name = ""
    )
    ...
    arcpy.analysis.SpatialJoin(
        ...
        join_operation = "JOIN_ONE_TO_ONE",
        join_type = "KEEP_ALL",
        field_mapping = f"KEY_ASSET \"KEY_ASSET\" true true false 4 Long 0 0,First,#,{PSR_Assets_Parent_CC},KEY_ASSET,-1,-1; LONGITUDE \"LONGITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_Parent_CC},LONGITUDE,-1,-1; LATITUDE \"LATITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_Parent_CC},LATITUDE,-1,-1; DIST_CITY_COUNCIL \" DIST_CITY_COUNCIL \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC}, DIST_CITY_COUNCIL,-1,-1; DIST_COMMUNITY \" DIST_COMMUNITY \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC}, DIST_COMMUNITY,-1,-1; DIST_CONGRESSIONAL \" DIST_CONGRESSIONAL \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC}, DIST_CONGRESSIONAL,-1,-1; DIST_STATE_ASSEMBLY \" DIST_STATE_ASSEMBLY \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC}, DIST_STATE_ASSEMBLY,-1,-1; DIST_STATE_SENATE \" DIST_STATE_SENATE \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC}, DIST_STATE_SENATE,-1,-1;City_Council_Parent_Dist_ID \"City_Council_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{PSR_Assets_Parent_CC}, City_Council_Parent_Dist_ID,-1,-1; Community_District_Parent_Dist_ID \"Community_District_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{communityDistrict}, BoroCD,-1,-1",
        search_radius = "", 
        distance_field_name = ""
    )
    ...
    arcpy.analysis.SpatialJoin(
        ...
        join_operation = "JOIN_ONE_TO_ONE",
        join_type = "KEEP_ALL",
        field_mapping = f"KEY_ASSET \"KEY_ASSET\" true true false 4 Long 0 0,First,#,{PSR_Assets_Parent_CC_CM},KEY_ASSET,-1,-1; LONGITUDE \"LONGITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_Parent_CC_CM},LONGITUDE,-1,-1; LATITUDE \"LATITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_Parent_CC_CM},LATITUDE,-1,-1; DIST_CITY_COUNCIL \" DIST_CITY_COUNCIL \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM}, DIST_CITY_COUNCIL,-1,-1; DIST_COMMUNITY \" DIST_COMMUNITY \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM}, DIST_COMMUNITY,-1,-1; DIST_CONGRESSIONAL \" DIST_CONGRESSIONAL \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM}, DIST_CONGRESSIONAL,-1,-1; DIST_STATE_ASSEMBLY \" DIST_STATE_ASSEMBLY \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM}, DIST_STATE_ASSEMBLY,-1,-1; DIST_STATE_SENATE \" DIST_STATE_SENATE \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM}, DIST_STATE_SENATE,-1,-1; City_Council_Parent_Dist_ID \"City_Council_Parent_Dist_ID \" true true false 10 Long 0 0,First,#, {PSR_Assets_Parent_CC_CM}, City_Council_Parent_Dist_ID,-1,-1; Community_District_Parent_Dist_ID \"Community_District_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{PSR_Assets_Parent_CC_CM}, Community_District_Parent_Dist_ID,-1,-1; Congressional_District_Parent_Dist_ID \"Congressional_District_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{congressionalDistrict}, CongDist,-1,-1",
        search_radius = "", 
        distance_field_name = ""
    )
    ...
    arcpy.analysis.SpatialJoin(
        ...
        join_operation = "JOIN_ONE_TO_ONE",
        join_type = "KEEP_ALL",
        field_mapping = f"KEY_ASSET \"KEY_ASSET\" true true false 4 Long 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO},KEY_ASSET,-1,-1; LONGITUDE \"LONGITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO},LONGITUDE,-1,-1; LATITUDE \"LATITUDE\" true true false 4 Double 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO},LATITUDE,-1,-1; DIST_CITY_COUNCIL \" DIST_CITY_COUNCIL \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, DIST_CITY_COUNCIL,-1,-1; DIST_COMMUNITY \" DIST_COMMUNITY \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, DIST_COMMUNITY,-1,-1; DIST_CONGRESSIONAL \" DIST_CONGRESSIONAL \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, DIST_CONGRESSIONAL,-1,-1; DIST_STATE_ASSEMBLY \" DIST_STATE_ASSEMBLY \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, DIST_STATE_ASSEMBLY,-1,-1; DIST_STATE_SENATE \" DIST_STATE_SENATE \" true true false 50 Text 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, DIST_STATE_SENATE,-1,-1; City_Council_Parent_Dist_ID \"City_Council_Parent_Dist_ID \" true true false 10 Long 0 0,First,#, {PSR_Assets_Parent_CC_CM_CO}, City_Council_Parent_Dist_ID,-1,-1; Community_District_Parent_Dist_ID \"Community_District_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, Community_District_Parent_Dist_ID,-1,-1; Congressional_District_Parent_Dist_ID \"Congressional_District_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{PSR_Assets_Parent_CC_CM_CO}, Congressional_District_Parent_Dist_ID,-1,-1; State_Assembly_Parent_Dist_ID \"State_Assembly_Parent_Dist_ID \" true true false 10 Long 0 0,First,#,{stateAssembly}, AssemDist,-1,-1",
        search_radius = "", 
        distance_field_name = ""
    )
